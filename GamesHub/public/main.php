            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-size" href="#">Sistemas Operativos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-size" href="#">Juegos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-size" href="#">Licencias</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-size" href="#">Targetas regalo</a>
                        </li>
                    </ul>
                    ...
                    <?php 
                         ...
                         foreach ($consulta as $filas) {
                          echo"  <div class='card' style='width: 18rem;'>
                            ...
                            <div class='card-body'>
                              <h5 class='card-title'>".$filas["Nombre"]."</h5>
